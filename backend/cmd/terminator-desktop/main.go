...
import (
	...
	"terminator-desktop/backend/internal/services/commandhistory"
...
func main() {
	...
	commandHistoryService := commandhistory.NewService(queries, v)
	...
	app.RegisterService(application.NewService(commandHistoryService))
